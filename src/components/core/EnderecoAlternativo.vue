    ...
    <v-expansion-panel-content :key="0" class="primary">
      ...
      <template slot="header">
        <span class="title white--text"
          >Endereço alternativo para correspondência</span
        >
      </template>
              ...
              <v-card>
                ...
                <v-card-text>
                  ...
                  <p>
                    ...
                    em
                    <span class="font-weight-black">INCLUIR CEP</span>.
                  </p>
                  <p>
...
export default {
  ...
  methods: {
    ...
    async carregarCidades(payloadUF) {
      // ? estado === payloadUF
      if (payloadUF) {
        this.value.uf = payloadUF;
        this.loadingCidades = true;
        await EstadoBusiness.getCidadesByUf(this.value.uf)
          .then((response) => {
