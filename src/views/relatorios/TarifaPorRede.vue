<template>
  <v-container
    fluid
    grid-list-md>
    <span class="title">Tarifa por rede</span>
    <v-form
      ref="form2"
...
export default {
  ...
  data () {
    return {
      ...
      tiposRel: [],
      tipos: [
        { id: TODAS_ID, descricao: 'Todos Lançamentos' },
        { id: '1', descricao: 'Tarifa por Parcela Banco' },
        { id: '2', descricao: 'Tarifa por Parcela Loja' },
      ],
      redes: [],
      loadingBtn: false,
      loading: false
    ...
    validateBeforeSubmit () {
      this.$validator.validate().then(result => {
        if (result) {
          ...
          RelatorioBusiness.geraTarifaPorRede(this.filtros)
            .then(response => {
